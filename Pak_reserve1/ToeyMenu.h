...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox4->Click += gcnew System::EventHandler(this, &ToeyMenu::pictureBox4_Click_1);
			// 
			// pictureBox5
			// 
			...
			this->pictureBox5->Location = System::Drawing::Point(22, 80);
			this->pictureBox5->Name = L"pictureBox5";
			this->pictureBox5->Size = System::Drawing::Size(230, 343);
			this->pictureBox5->TabIndex = 16;
			this->pictureBox5->TabStop = false;
			this->pictureBox5->MouseLeave += gcnew System::EventHandler(this, &ToeyMenu::pictureBox5_MouseLeave);
			this->pictureBox5->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &ToeyMenu::pictureBox5_MouseMove);
			// 
			// pictureBox6
			// 
			this->pictureBox6->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox6.Image")));
			this->pictureBox6->Location = System::Drawing::Point(33, 150);
			...
			this->pictureBox7->Location = System::Drawing::Point(33, 212);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(75, 155);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(66, 25);
			this->label2->TabIndex = 20;
			this->label2->Text = L"45/70";
			this->label2->Click += gcnew System::EventHandler(this, &ToeyMenu::label2_Click);
			// 
			// label3
			// 
