...
namespace Pakreserve1 {
	...
	/// <summary>
	/// Summary for BarSRTxz
	/// </summary>
	public ref class BarSRTxz : public System::Windows::Forms::Form
	{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BarSRTxz::typeid));
			...
			this->A1Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A1Table1P_Click);
			// 
			// A2Table1P
			// 
			...
			this->A2Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A2Table1P_Click);
			// 
			// A3Table1P
			// 
			...
			this->A3Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A3Table1P_Click);
			// 
			// A4Table1P
			// 
			...
			this->A4Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A4Table1P_Click);
			// 
			// A5Table1P
			// 
			...
			this->A5Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A5Table1P_Click);
			// 
			// A6Table1P
			// 
			...
			this->A6Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A6Table1P_Click);
			// 
			// A7Table1P
			// 
			...
			this->A7Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A7Table1P_Click);
			// 
			// A8Table1P
			// 
			...
			this->A8Table1P->Click += gcnew System::EventHandler(this, &BarSRTxz::A8Table1P_Click);
			// 
			// B1Table4P
			// 
			...
			this->B1Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B1Table4P_Click);
			// 
			// B2Table4P
			// 
			...
			this->B2Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B2Table4P_Click);
			// 
			// B3Table4P
			// 
			...
			this->B3Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B3Table4P_Click);
			// 
			// B4Table4P
			// 
			...
			this->B4Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B4Table4P_Click);
			// 
			// B5Table4P
			// 
			...
			this->B5Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B5Table4P_Click);
			// 
			// B6Table4P
			// 
			...
			this->B6Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B6Table4P_Click);
			// 
			// B7Table4P
			// 
			...
			this->B7Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::B7Table4P_Click);
			// 
			// C1Table4P
			// 
			...
			this->C1Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C1Table4P_Click);
			// 
			// C2Table4P
			// 
			...
			this->C2Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C2Table4P_Click);
			// 
			// C3Table4P
			// 
			...
			this->C3Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C3Table4P_Click);
			// 
			// C4Table4P
			// 
			...
			this->C4Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C4Table4P_Click);
			// 
			// C5Table4P
			// 
			...
			this->C5Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C5Table4P_Click);
			// 
			// C6Table4P
			// 
			...
			this->C6Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C6Table4P_Click);
			// 
			// C7Table4P
			// 
			...
			this->C7Table4P->Click += gcnew System::EventHandler(this, &BarSRTxz::C7Table4P_Click);
			// 
			// A1Table1PGreen
			// 
			...
			this->A1Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A1Table1PGreen_Click);
			// 
			// A2Table1PGreen
			// 
			...
			this->A2Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A2Table1PGreen_Click);
			// 
			// A3Table1PGreen
			// 
			...
			this->A3Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A3Table1PGreen_Click);
			// 
			// A4Table1PGreen
			// 
			...
			this->A4Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A4Table1PGreen_Click);
			// 
			// A5Table1PGreen
			// 
			...
			this->A5Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A5Table1PGreen_Click);
			// 
			// A6Table1PGreen
			// 
			...
			this->A6Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A6Table1PGreen_Click);
			// 
			// A7Table1PGreen
			// 
			...
			this->A7Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A7Table1PGreen_Click);
			// 
			// A8Table1PGreen
			// 
			...
			this->A8Table1PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::A8Table1PGreen_Click);
			// 
			// B1Table4PGreen
			// 
			...
			this->B1Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B1Table4PGreen_Click);
			// 
			// B2Table4PGreen
			// 
			...
			this->B2Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B2Table4PGreen_Click);
			// 
			// B3Table4PGreen
			// 
			...
			this->B3Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B3Table4PGreen_Click);
			// 
			// B4Table4PGreen
			// 
			...
			this->B4Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B4Table4PGreen_Click);
			// 
			// B5Table4PGreen
			// 
			...
			this->B5Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B5Table4PGreen_Click);
			// 
			// B6Table4PGreen
			// 
			...
			this->B6Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B6Table4PGreen_Click);
			// 
			// B7Table4PGreen
			// 
			...
			this->B7Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::B7Table4PGreen_Click);
			// 
			// C1Table4PGreen
			// 
			...
			this->C1Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C1Table4PGreen_Click);
			// 
			// C2Table4PGreen
			// 
			...
			this->C2Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C2Table4PGreen_Click);
			// 
			// C3Table4PGreen
			// 
			...
			this->C3Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C3Table4PGreen_Click);
			// 
			// C4Table4PGreen
			// 
			...
			this->C4Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C4Table4PGreen_Click);
			// 
			// C5Table4PGreen
			// 
			...
			this->C5Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C5Table4PGreen_Click);
			// 
			// C6Table4PGreen
			// 
			...
			this->C6Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C6Table4PGreen_Click);
			// 
			// C7Table4PGreen
			// 
			...
			this->C7Table4PGreen->Click += gcnew System::EventHandler(this, &BarSRTxz::C7Table4PGreen_Click);
			// 
			// A8Table1PRed
			// 
			...
			this->A8Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A8Table1PRed_Click);
			// 
			// A7Table1PRed
			// 
			...
			this->A7Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A7Table1PRed_Click);
			// 
			// A6Table1PRed
			// 
			...
			this->A6Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A6Table1PRed_Click);
			// 
			// A5Table1PRed
			// 
			...
			this->A5Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A5Table1PRed_Click);
			// 
			// A4Table1PRed
			// 
			...
			this->A4Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A4Table1PRed_Click);
			// 
			// A3Table1PRed
			// 
			...
			this->A3Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A3Table1PRed_Click);
			// 
			// A2Table1PRed
			// 
			...
			this->A2Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A2Table1PRed_Click);
			// 
			// A1Table1PRed
			// 
			...
			this->A1Table1PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::A1Table1PRed_Click);
			// 
			// B1Table4PRed
			// 
			...
			this->B1Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B1Table4PRed_Click);
			// 
			// C2Table4PRed
			// 
			...
			this->C2Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C2Table4PRed_Click);
			// 
			// C1Table4PRed
			// 
			...
			this->C1Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C1Table4PRed_Click);
			// 
			// B7Table4PRed
			// 
			...
			this->B7Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B7Table4PRed_Click);
			// 
			// B6Table4PRed
			// 
			...
			this->B6Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B6Table4PRed_Click);
			// 
			// B5Table4PRed
			// 
			...
			this->B5Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B5Table4PRed_Click);
			// 
			// B4Table4PRed
			// 
			...
			this->B4Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B4Table4PRed_Click);
			// 
			// B3Table4PRed
			// 
			...
			this->B3Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B3Table4PRed_Click);
			// 
			// B2Table4PRed
			// 
			...
			this->B2Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::B2Table4PRed_Click);
			// 
			// C7Table4PRed
			// 
			...
			this->C7Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C7Table4PRed_Click);
			// 
			// C6Table4PRed
			// 
			...
			this->C6Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C6Table4PRed_Click);
			// 
			// C5Table4PRed
			// 
			...
			this->C5Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C5Table4PRed_Click);
			// 
			// C4Table4PRed
			// 
			...
			this->C4Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C4Table4PRed_Click);
			// 
			// C3Table4PRed
			// 
			...
			this->C3Table4PRed->Click += gcnew System::EventHandler(this, &BarSRTxz::C3Table4PRed_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &BarSRTxz::pictureBox1_Click);
			// 
			...
			this->ConfirmTableBarMapraw->Click += gcnew System::EventHandler(this, &BarSRTxz::ConfirmTableBarMapraw_Click);
			// 
			// panel1
			// 
			...
			this->pictureBox3->Click += gcnew System::EventHandler(this, &BarSRTxz::pictureBox3_Click);
			// 
			// pictureBox2
			// 
			...
			this->pictureBox2->Click += gcnew System::EventHandler(this, &BarSRTxz::pictureBox2_Click);
			// 
			// exitpnl
			// 
			...
			this->noExit->Click += gcnew System::EventHandler(this, &BarSRTxz::noExit_Click);
			// 
			// yesExit
			// 
			...
			this->yesExit->Click += gcnew System::EventHandler(this, &BarSRTxz::yesExit_Click);
			// 
			// Table
			// 
			...
			this->Name = L"BarSRTxz";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"BarSRTxz";
			this->Load += gcnew System::EventHandler(this, &BarSRTxz::BarSRTxz_Load);
			this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &BarSRTxz::BarSRTxz_KeyDown);
...
#pragma endregion
	...
	private: System::Void BarSRTxz_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void BarSRTxz_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
