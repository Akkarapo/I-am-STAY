...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->A1Table4PGreen->Click += gcnew System::EventHandler(this, &BarNatwaa::A1Table4P_Click);
			// 
			// A2Table4P
			// 
			...
			this->A3Table4PGreen->Click += gcnew System::EventHandler(this, &BarNatwaa::A3Table4P_Click);
			// 
			// A4Table4PGreen
			// 
			...
			this->A4Table4PGreen->Click += gcnew System::EventHandler(this, &BarNatwaa::A4Table4P_Click);
			// 
			// A5Table4PGreen
			// 
			...
			this->A5Table4PGreen->Click += gcnew System::EventHandler(this, &BarNatwaa::A5Table4P_Click);
			// 
			// A6Table4PGreen
			// 
			...
			this->A6Table4PGreen->Click += gcnew System::EventHandler(this, &BarNatwaa::A6Table4P_Click);
			// 
			// A7Table4P
			// 
			...
			this->A8Table4PGreen->Click += gcnew System::EventHandler(this, &BarNatwaa::A8Table4P_Click);
			// 
			// A1Table4P
			// 
			...
			this->A1Table4P->Click += gcnew System::EventHandler(this, &BarNatwaa::A1Table4PGreen_Click);
			// 
			// A2Table4PGreen
			// 
			...
			this->A3Table4P->Click += gcnew System::EventHandler(this, &BarNatwaa::A3Table4PGreen_Click);
			// 
			// A4Table4P
			// 
			...
			this->A4Table4P->Click += gcnew System::EventHandler(this, &BarNatwaa::A4Table4PGreen_Click);
			// 
			// A5Table4P
			// 
			...
			this->A5Table4P->Click += gcnew System::EventHandler(this, &BarNatwaa::A5Table4PGreen_Click);
			// 
			// A6Table4P
			// 
			...
			this->A6Table4P->Click += gcnew System::EventHandler(this, &BarNatwaa::A6Table4PGreen_Click);
			// 
			// A7Table4PGreen
			// 
			...
			this->A8Table4P->Click += gcnew System::EventHandler(this, &BarNatwaa::A8Table4PGreen_Click);
			// 
			// A1Table4PRed
			// 
			this->A1Table4PRed->BackColor = System::Drawing::Color::Transparent;
			this->A1Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A1Table4PRed.BackgroundImage")));
			...
			this->A8Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A8Table4PRed.BackgroundImage")));
			...
			this->A7Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A7Table4PRed.BackgroundImage")));
			...
			this->A6Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A6Table4PRed.BackgroundImage")));
			...
			this->A5Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A5Table4PRed.BackgroundImage")));
			...
			this->A4Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A4Table4PRed.BackgroundImage")));
			...
			this->A3Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A3Table4PRed.BackgroundImage")));
			...
			this->A2Table4PRed->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"A2Table4PRed.BackgroundImage")));
