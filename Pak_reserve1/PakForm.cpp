...
void main(array<String^>^ args)
{
    ...
    Pakreserve1::BarSRTxz bar14(user);
    Pakreserve1::Bar422 bar15(user);
    ...
    while (true) {
        if (mpform.switchToProfile || form.switchToProfile || profileform.switchToProfile || Toeyform.switchToProfile) {
        ...
        else if (form2.switchToToey || bar2.switchToToey || bar15.switchToToey || bar14.switchToToey || bar10.switchToToey || bar3.switchToToey || bar4.switchToToey || bar5.switchToToey || bar6.switchToToey || bar11.switchToToey || profileform.switchToToey || mpform.switchToToey || form.switchToToey || bar7.switchToToey || bar12.switchToToey || bar8.switchToToey || bar13.switchToToey || bar9.switchToToey) {
            ...
            bar14.switchToToey = false;
            bar15.switchToToey = false;
        ...
        else if (form.switchToMP || bar2.switchToMP || bar14.switchToMP || bar15.switchToMP || bar3.switchToMP || bar10.switchToMP || bar9.switchToMP || bar4.switchToMP || bar5.switchToMP || bar7.switchToMP || bar6.switchToMP || bar12.switchToMP|| bar8.switchToMP || bar11.switchToMP || bar13.switchToMP)
        {
            mpform.ShowDialog();
            ...
            bar14.switchToMP = false;
            bar15.switchToMP = false;
        ...
        else if (Toeyform.switchToBarSRTxz)
        {
            bar14.ShowDialog();
            Toeyform.switchToBarSRTxz = false;
        }
        else if (Toeyform.switchToBar422)
        {
            bar15.ShowDialog();
            Toeyform.switchToBar422 = false;
            }
        else
        {
            break;
